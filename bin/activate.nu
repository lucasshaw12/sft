...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/Lucas/Python/Python-Projects/Stocks fund tracker'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/Lucas/Python/Python-Projects/Stocks fund tracker/bin/deactivate.nu'
